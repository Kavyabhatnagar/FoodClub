    ...
    <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
      <div className="grid lg:grid-cols-2 grid-cols-1 gap-x-24">
          <div className="flex items-center lg:mb-0 mb-10">
              <div>
                  <h4 className="text-pink-700  text-4xl font-medium leading-6 mb-4 lg:text-left text-center">Contact Us</h4>
                  <h2 className="text-gray-400 font-manrope text-2xl font-semibold leading-10 mb-9 lg:text-left text-center">Reach Out To Us</h2>
                  <form action="">
                  ...
                  <button className="w-full h-12 text-center text-white text-base font-semibold leading-6 rounded-full bg-pink-700 shadow transition-all duration-700 hover:bg-pink-400">Submit</button>
                  </form>
              </div>
          </div>
              ...
              <div className="">
                  <div className="lg:w-96 w-auto h-auto bg-white shadow-xl lg:p-6 p-4">
                      ...
                      <a href="javascript:;" className="flex items-center mb-6">
                          ...
                          <h5 className="text-black text-base font-normal leading-6 ml-5">FoodHub1234@gmail.com</h5>
                      </a>
                      <a href="javascript:;" className="flex items-center mb-6">
                          <svg width="30" height="30" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
